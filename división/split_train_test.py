...
def split_train_test(ruta_csv, test_size=0.2, random_state=42):
    ...
    X = df.drop(columns=["Etiqueta", "Archivo_Imagen", "Fecha", "Hora", "Usuario", "Usuario_cod", "Etiqueta_cod", "mean_h", "mean_s", "mean_v", "mean_a", "std_l", "v_range", "h_s_product", "v_skew_abs"])
    y = df["Etiqueta"]
